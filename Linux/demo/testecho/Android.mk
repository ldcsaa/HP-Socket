...
# target lib : hp-testecho-server
include $(CLEAR_VARS)
LOCAL_MODULE     := hp-testecho-server
...
# target lib :  hp-testecho-client
include $(CLEAR_VARS)
LOCAL_MODULE     := hp-testecho-client
...
# target lib :  hp-testecho-agent
include $(CLEAR_VARS)
LOCAL_MODULE     := hp-testecho-agent
