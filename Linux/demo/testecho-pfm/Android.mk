...
# target lib : hp-testecho-pfm-server
include $(CLEAR_VARS)
LOCAL_MODULE     := hp-testecho-pfm-server
...
# target lib :  hp-testecho-pfm-client
include $(CLEAR_VARS)
LOCAL_MODULE     := hp-testecho-pfm-client
...
# target lib :  hp-testecho-pfm-agent
include $(CLEAR_VARS)
LOCAL_MODULE     := hp-testecho-pfm-agent
