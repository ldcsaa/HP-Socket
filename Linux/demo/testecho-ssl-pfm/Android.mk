...
# target lib : hp-testecho-ssl-pfm-server
include $(CLEAR_VARS)
LOCAL_MODULE     := hp-testecho-ssl-pfm-server
...
# target lib :  hp-testecho-ssl-pfm-client
include $(CLEAR_VARS)
LOCAL_MODULE     := hp-testecho-ssl-pfm-client
...
# target lib :  hp-testecho-ssl-pfm-agent
include $(CLEAR_VARS)
LOCAL_MODULE     := hp-testecho-ssl-pfm-agent
