...
# target lib : hp-testecho-udp-pfm-server
include $(CLEAR_VARS)
LOCAL_MODULE     := hp-testecho-udp-pfm-server
...
# target lib :  hp-testecho-udp-pfm-client
include $(CLEAR_VARS)
LOCAL_MODULE     := hp-testecho-udp-pfm-client
